System.register(["@angular/core", "@angular/http", "rxjs/add/operator/map"], function (exports_1, context_1) {
    ...
    var core_1, http_1, FilterPresetRestService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            FilterPresetRestService = (function () {
                function FilterPresetRestService(_http) {
                    this._http = _http;
                }
                ...
                return FilterPresetRestService;
            }());
            FilterPresetRestService = __decorate([
                core_1.Injectable(),
                __metadata("design:paramtypes", [http_1.Http])
            ], FilterPresetRestService);
            exports_1("FilterPresetRestService", FilterPresetRestService);
        }
    };
});
//# sourceMappingURL=filter-preset-rest.service.js.map